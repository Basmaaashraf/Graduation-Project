...
class VendorProfile extends StatefulWidget {
  @override
  _vendorProfile createState() => _vendorProfile();
}
...
class _vendorProfile extends State<VendorProfile> {
  ...
  Widget build(BuildContext context) {
    var name = userValue.containsKey("name")?userValue["name"].toString():"Name";
    var image = userValue.containsKey("image")?userValue["image"].toString():"";
    var email = FirebaseAuth.instance.currentUser!=null?
